...
output_part_folder = os.path.abspath("rgb_rs/sliced_t1_fast_cam1")  # 保存渲染所得的各相机的行图像文件夹
output_folder = os.path.abspath("rgb_rs/t1_fast_cam1")  # 保存拼接所得的卷帘图像文件夹
output_folder_gs = "rgb_gs/t1_fast/t1_cam1"  # 保存全局图像的文件夹
...
specified_files = [f't1_fast_cam1_frame_{i:06d}.txt' for i in range(41, 314)]
# 获取所有的frame位姿文件
...
# # 获取所有的位姿文件
# frame_files = sorted([f for f in os.listdir(motion_folder) if f.startswith('t1_fast_cam1_frame_')])
