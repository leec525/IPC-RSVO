...
// *** CONTROL CENTER ***
/* #declare use_radiosity=2; // 1st pass: 2 / final: 1
#declare use_area     =0; // 1st pass: 0 / final: 1
#declare use_blur    = 0; // 1st pass: 0 / final: >50 at least
#declare use_textures =1; // 1st pass: 0 / final: 1 //modified to 1 by xlab
#declare use_normals  =0; // 1st pass: 0 / final: 1
#declare use_glass    =0; // 1st pass: 0 / final: 1
#declare use_wshaders =1; // 1st pass: 0 / final: 1 //modified to 1 by xlab
#declare use_dandw    =1;
#declare use_clock    =1;
...
#declare use_smoking  =1;
#declare use_dlamps   =1;
#declare use_fluoresc =1;
#declare use_daylight =0;
#declare camera_select=2; // see eof
#declare use_xlab_rd_data = 0;
#declare use_stand_column =0; */

// *** CONTROL CENTER ***
#declare use_radiosity=2; // 1st pass: 2 / final: 1 2->0 by xlab
#declare use_area     =0; // 1st pass: 0 / final: 1
#declare use_blur    = 0; // 1st pass: 0 / final: >50 at least
#declare use_textures =0; // 1st pass: 0 / final: 1 //modified to 1 by xlab
#declare use_normals  =0; // 1st pass: 0 / final: 1
#declare use_glass    =0; // 1st pass: 0 / final: 1
#declare use_wshaders =0; // 1st pass: 0 / final: 1 //modified to 1 by xlab
#declare use_dandw    =0;
#declare use_clock    =0;
#declare use_tables   =0;
#declare use_plants   =0;
#declare use_radio    =0;
#declare use_phones   =0;
#declare use_wchairs  =0;
#declare use_nchairs  =0;
#declare use_computers=0;
#declare use_bookcases=0;
#declare use_books    =0;
#declare use_filers   =0;
#declare use_clothrack=0;
#declare use_pictures =0;
#declare use_boxes    =0;
#declare use_calc     =0;
#declare use_papercans=0;
#declare use_paperwork=0;
#declare use_calendars=0;
#declare use_penpots  =0;
#declare use_post_it  =0;
#declare use_coffemugs=0;
#declare use_smoking  =0;
#declare use_dlamps   =0;
#declare use_fluoresc =1;//这里用了以后会有光
#declare use_daylight =0;
#declare camera_select=2; // see eof
#declare use_xlab_rd_data = 0;
#declare use_stand_column =0;
...
#declare Lightsys_Scene_Scale =1.5;//这里定义亮度大小，默认是1，数值越大，渲染出来的图片越亮。
...
// object{keyb_cable5 rotate  199*y translate table1_pos+<40,81.1,19-3>}
 ...
 object{keyboard    rotate  0*y translate table3_pos+<20,82.1,-19>}
...
/* object{frame_xlab rotate -1*x scale <.9,.7,.5> /// This is the new picture added to the wall by xlab!
 rotate 90*y
 translate <room_width*.5-2,150,-60>
 translate office_height*y
} */
